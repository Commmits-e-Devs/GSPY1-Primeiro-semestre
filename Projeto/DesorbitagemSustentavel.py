...
def avaliar_sustentabilidade_satelite(satelite):
    ...
    if satelite["combustivel"] <= LIMITE_MINIMO_COMBUSTIVEL_PORCENTO:
        print(f"⚠️ Alerta de Fim de Vida Utilizado! Combustível abaixo de {LIMITE_MINIMO_COMBUSTIVEL_PORCENTO}%.")
...
# --- EXECUÇÃO DO PROTÓTIPO 5 ---
# executar_sustentabilidade = executar_auditoria_ambiental_espacial(lista_de_satelites_proprios)