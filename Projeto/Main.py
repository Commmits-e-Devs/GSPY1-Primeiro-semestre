...
gerar_lixo_espacial(minha_orbita, 30) # mudando esse numero ele vai ficar com mais espaço na hora de enviar e vai fazer a entrada mais facil

# 3. Tentamos lançar nosso satélite nessa mesma matriz
lancar_satelite(minha_orbita, "Satélite FIAP", altitude=0, angulo=90)